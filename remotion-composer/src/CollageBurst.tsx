...
// Self-hosted Playfair Display (CSS imported in Root.tsx via @fontsource/playfair-display).
const playfairFamily = "Playfair Display";
const playfairItalic = "Playfair Display";
